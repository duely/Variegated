...
import com.noobanidus.variegated.com.noobanidus.variegated.VariegatedConfig;
...
public class ConditionFactory implements IConditionFactory {
  ...
  public BooleanSupplier parse(JsonContext context, JsonObject json) {
    ...
    if (key.equalsIgnoreCase("apple")) {
      ...
      return () -> Loader.isModLoaded("thaumcraft") && com.noobanidus.variegated.VariegatedConfig.Thaumcraft.enabled;
    } else if (key.equalsIgnoreCase("featherweight")) {
      return () -> com.noobanidus.variegated.VariegatedConfig.enableFeatherweight;
